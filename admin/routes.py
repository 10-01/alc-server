...
_routes = [
    ...
    RedirectRoute('/admin/connections/', users.AdminConnectionHandler, name='connection-list', strict_slash=True),
    RedirectRoute('/admin/connection/<connection_id>', users.AdminConnectionEditHandler, name='connection-edit', strict_slash=True),
    RedirectRoute('/admin/map', users.AdminMapEditHandler, name='admin-map', strict_slash=True),
