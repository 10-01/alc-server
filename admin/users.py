...
class AdminConnectionHandler(BaseHandler):
    def get(self):
        return self.render_template('admin/connections.html')

class AdminConnectionEditHandler(BaseHandler):
    def get(self, connection_id):
        return self.render_template('admin/edit_connection.html', connection_id=connection_id)

class AdminMapEditHandler(BaseHandler):
    def get(self):
        return self.render_template('admin/admin_map.html')
